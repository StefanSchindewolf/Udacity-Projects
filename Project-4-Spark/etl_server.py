...
def create_spark_session():
    ...
    sc._jsc.hadoopConfiguration().set("fs.s3n.awsAccessKeyId", config.get('AWS', 'AWS_ACCESS_KEY_ID'))
    sc._jsc.hadoopConfiguration().set("fs.s3n.awsSecretAccessKey", config.get('AWS', 'AWS_SECRET_ACCESS_KEY'))
